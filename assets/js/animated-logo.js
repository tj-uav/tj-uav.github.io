...
(function drawUAVlogo(scale) {
	...
	let hasSeenAnimation = getCookie('hasSeenAnimation')
	console.log(hasSeenAnimation)
	if (hasSeenAnimation == '') {
		console.log("show animation")
		setCookie('hasSeenAnimation', 'true', 1)
		...
		document.querySelector('section#banner.animated-banner').style.animationDuration = 0
		document.querySelector('nav#nav.animated-nav').style.animationDuration = 0
	}
